...
<html>
    <head>
        <title><spring:message code="form.update.pageTitle"/></title>
    ...
    <body>
        ...
        <div class="container-fluid container" style="margin-top:80px">
            ...
            <h3 class="mb-4">
                <spring:message code="form.update.heading"/>
            </h3>

            <form:form class="" action="updateCustomer" modelAttribute="customerDto">

                <div class="row align-items-start">
                    <div class="form-group col-5">
                        <spring:message code="form.field.customerCode" />
                        <form:input class="form-control" path="customerCode" pattern="^[a-zA-Z0-9]*$" required="true" readonly="true"/>
                ...
                <div class="row align-items-start">
                    ...
                    <!-- <form:label path="customerAddress1">Enter Customer Address line1: </form:label>
                    <form:input path="customerAddress1" />
                    <form:errors path="customerAddress1" cssClass="error" /> -->
                    ...
                    <!-- <form:label path="customerAddress2">Enter Customer Address line2: </form:label>
                    <form:input path="customerAddress2" />
                    <form:errors path="customerAddress2" cssClass="error" /> -->
                </div>
                ...
                <div class="row align-items-start">
                    ...
                    <!-- <form:label path="customerPinCode">Enter Pin Code: </form:label>
                    <form:input path="customerPinCode" />
                    <form:errors path="customerPinCode" cssClass="error" />
                    <br><br>

                    <form:label path="emailAddress">Enter Email Address: </form:label>
                ...
                <div class="row align-items-start">
                    ...
                    <form:label path="primaryContactPerson">Enter Contact Person details: </form:label>
                    <form:input path="primaryContactPerson"/>
                    <form:errors path="primaryContactPerson" cssClass="error" /> -->
                ...
                <div class="form-group col-5">
                    ...
                    <!-- <form:label path="activeInactiveFlag">Select Flag: </form:label>
                ...
                <button path="Update" class="btn btn-primary" type="submit">
                    <spring:message code="form.btn.update" />
                </button>
                </div>
            </form:form>
        </div>
