...
<%@ page import="com.model.dto.CustomerDTO, java.util.List, java.util.ArrayList" %>
        ...
        <div style="margin-top:80px">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;
                        <a href="updatePage?customerCode=<%= c.getCustomerCode()%>"+ <%= c.getCustomerCode() %>><i class='far fa-edit' style="color:blue"></i></a>
                        &nbsp;
                        <a href="deletePage?customerCode=<%= c.getCustomerCode()%>"><i class="fas fa-trash" style="color:red"></i></a>
                        &nbsp;
                    </td>
                </tr>
                ...
                <%
                    ...
                    for(CustomerDTO c: masterCustomers){
                        if(!(customerCodes.contains(c.getCustomerCode()))){
